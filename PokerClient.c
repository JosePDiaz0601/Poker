    ...
    {   SocketFD = socket(AF_INET, SOCK_STREAM, 0);
        ...
        if (RecvBuf[0] == '1'){
           ...
           makeCards(your2CardSuit, your2CardType, pCard2);
            ...
            currentplayerturn = (RecvBuf[strlen(RecvBuf) -1] - '0');
            if ((tempplayernum == ClientSeatNumInt) && (ClientSeatNumInt == currentplayerturn)){         // checking if this specific client called
            ...
            tempplayernum = (RecvBuf[1] - '0');
            currentplayerturn = (RecvBuf[strlen(RecvBuf) -1] - '0');
            if ((tempplayernum == ClientSeatNumInt) && (ClientSeatNumInt == currentplayerturn)){  
